...
namespace ns3 {
  namespace mih {
    ...
    {
      return TlvMih::GetSerializedSizeString (m_networkIdentifier);
    }
    void
    ...
    {
      TlvMih::SerializeString (buffer, m_networkIdentifier, GetTlvTypeValue ());
    }
    uint32_t 
    NetworkIdentifier::TlvDeserialize (Buffer &buffer)
    {
      return TlvMih::DeserializeString (buffer, m_networkIdentifier, GetTlvTypeValue ());
    }
  } // namespace mih
} // namespace ns3
