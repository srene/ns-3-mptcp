...
namespace ns3 {
  namespace mih {
    ...
    {
      return TlvMih::GetSerializedSize<LinkStatesResponse> (linkStatesResponseList);
    }
    void
    TlvSerialize (Buffer &buffer, const LinkStatesResponseList &linkStatesResponseList)
    {
      TlvMih::Serialize<LinkStatesResponse> (buffer, linkStatesResponseList, TLV_LINK_STATES_RESPONSE_LIST);
    }
    uint32_t
    TlvDeserialize (Buffer &buffer, LinkStatesResponseList &linkStatesResponseList)
    {
      return TlvMih::Deserialize<LinkStatesResponse> (buffer, linkStatesResponseList, TLV_LINK_STATES_RESPONSE_LIST);      
    }
  } // namespace mih
} // namespace ns3
