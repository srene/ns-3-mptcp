...
namespace ns3 {
  namespace mih {
    ...
    {
      return TlvMih::GetSerializedSizeString (m_mihfid);
    }
    void
    ...
    {
      TlvMih::SerializeString (buffer, m_mihfid, GetTlvTypeValue ());
    }
    uint32_t 
    MihfId::TlvDeserialize (Buffer &buffer)
    {
      return TlvMih::DeserializeString (buffer, m_mihfid, GetTlvTypeValue ());
    }
    MihfId&
