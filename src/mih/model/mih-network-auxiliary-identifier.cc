...
namespace ns3 {
  namespace mih {
    ...
    {
      return TlvMih::GetSerializedSizeString (m_networkAuxiliaryIdentifier);
    }
    void
    ...
    {
      TlvMih::SerializeString (buffer, m_networkAuxiliaryIdentifier, GetTlvTypeValue ());
    }
    uint32_t 
    NetworkAuxiliaryIdentifier::TlvDeserialize (Buffer &buffer)
    {
      return TlvMih::DeserializeString (buffer, m_networkAuxiliaryIdentifier, GetTlvTypeValue ());
    }
  } // namespace mih
} // namespace ns3
