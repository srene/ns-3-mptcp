...
namespace ns3 {
  namespace mih {
    ...
    {
      return TlvMih::GetSerializedSize<LinkDescriptorsResponse> (linkDescriptorsResponseList);
    }
    void
    TlvSerialize (Buffer &buffer, const LinkDescriptorsResponseList &linkDescriptorsResponseList)
    {
      TlvMih::Serialize<LinkDescriptorsResponse> (buffer, 
    ...
    {
      return TlvMih::Deserialize<LinkDescriptorsResponse> (buffer, 
                                                        linkDescriptorsResponseList, 
                                                        TLV_LINK_DESCRIPTORS_RESPONSE_LIST);      
    }
  } // namespace mih
