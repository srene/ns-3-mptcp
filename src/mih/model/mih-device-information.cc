...
namespace ns3 {
  namespace mih {
    ...
    DeviceInformation::GetTlvSerializedSize (void) const
    {
      ...
      payloadLength = TlvMih::GetSerializedSizeString (m_deviceInformation) +
    ...
    DeviceInformation::TlvSerialize (Buffer &buffer) const
    {
      ...
      TlvMih::WritePayloadLengthField (i, payloadLength); // Length
                                                       // field;
      TlvMih::SerializeString (buffer, m_deviceInformation, GetTlvTypeValue ());
    ...
    DeviceInformation::TlvDeserialize (Buffer &buffer)
    {
      ...
      totalBytesRead += TlvMih::DeserializeString (buffer, m_deviceInformation, GetTlvTypeValue ());
