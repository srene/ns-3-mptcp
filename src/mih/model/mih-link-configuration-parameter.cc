  ...
  namespace mih {
    ...
    LinkConfigurationParameter::GetTlvSerializedSize (void) const
    {
      ...
      payloadLength = m_linkParameterType->GetTlvSerializedSize () +
        TlvMih::GetSerializedSizeU64 () +
        TlvMih::GetSerializedSizeU8 () +
        TlvMih::GetSerializedSize (m_thresholdList);
    ...
    LinkConfigurationParameter::TlvSerialize (Buffer &buffer) const
    {
      ...
      TlvMih::WritePayloadLengthField (i, payloadLength); // Length
                                                       // field;
      
      m_linkParameterType->TlvSerialize (buffer);
      TlvMih::SerializeU64 (buffer, m_timerInterval, TLV_LINK_CONFIGURATION_TIME_INTERVAL);
      TlvMih::SerializeU8 (buffer, static_cast<uint8_t> (m_thresholdAction), TLV_LINK_CONFIGURATION_THRESHOLD_ACTION);
    ...
    LinkConfigurationParameter::TlvDeserialize (Buffer &buffer)
    {
      ...
      totalBytesRead += TlvMih::DeserializeU64 (buffer, m_timerInterval, TLV_LINK_CONFIGURATION_TIME_INTERVAL);
      uint8_t thresholdAction = 0;
      totalBytesRead += TlvMih::DeserializeU8 (buffer, thresholdAction, TLV_LINK_CONFIGURATION_THRESHOLD_ACTION);
    ...
    {
      return TlvMih::GetSerializedSize<LinkConfigurationParameter> (linkConfigurationParameterList);
    }
    void
    TlvSerialize (Buffer &buffer, const LinkConfigurationParameterList &linkConfigurationParameterList)
    {
      TlvMih::Serialize<LinkConfigurationParameter> (buffer, linkConfigurationParameterList, TLV_LINK_CONFIGURATION_PARAMETER_LIST);
    }
    uint32_t
    TlvDeserialize (Buffer &buffer, LinkConfigurationParameterList &linkConfigurationParameterList)
    {
      return TlvMih::Deserialize<LinkConfigurationParameter> (buffer, linkConfigurationParameterList, TLV_LINK_CONFIGURATION_PARAMETER_LIST);      
    }
  } // namespace mih
} // namespace ns3
