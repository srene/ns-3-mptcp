  ...
  namespace mih {
    ...
    LinkActionResponse::GetTlvSerializedSize (void) const
    {
      ...
      payloadLength = m_linkType.GetTlvSerializedSize () +
        TlvMih::GetSerializedSize (m_mobileNodeAddress) +
    ...
    LinkActionResponse::TlvSerialize (Buffer &buffer) const
    {
      ...
      TlvMih::Serialize (buffer, m_mobileNodeAddress, TLV_MN_LINK_IDENTIFIER);
      TlvMih::SerializeU8 (buffer, static_cast<uint8_t> (m_linkActionResult), TLV_LINK_ACTION_RESULT);
    ...
    LinkActionResponse::TlvDeserialize (Buffer &buffer)
    {
      ...
      totalBytesRead += TlvMih::Deserialize (buffer, m_mobileNodeAddress, TLV_MN_LINK_IDENTIFIER);
      uint8_t actionResult = 0;
      totalBytesRead += TlvMih::DeserializeU8 (buffer, actionResult, TLV_LINK_ACTION_RESULT);
    ...
    {
      return TlvMih::GetSerializedSize<LinkActionResponse> (linkActionResponseList);
    }
    void
    TlvSerialize (Buffer &buffer, const LinkActionResponseList &linkActionResponseList)
    {
      TlvMih::Serialize<LinkActionResponse> (buffer, linkActionResponseList, TLV_LINK_ACTION_RESPONSE_LIST);
    }
    uint32_t
    TlvDeserialize (Buffer &buffer, LinkActionResponseList &linkActionResponseList)
    {
      return TlvMih::Deserialize<LinkActionResponse> (buffer, linkActionResponseList, TLV_LINK_ACTION_RESPONSE_LIST);    
    }
    std::ostream&
