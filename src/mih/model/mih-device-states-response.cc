...
namespace ns3 {
  namespace mih {
    ...
    {
      return TlvMih::GetSerializedSize<DeviceStatesResponse> (deviceStatesResponseList);
    }
    void
    TlvSerialize (Buffer &buffer, const DeviceStatesResponseList &deviceStatesResponseList)
    {
      TlvMih::Serialize<DeviceStatesResponse> (buffer, 
    ...
    {
      return TlvMih::Deserialize<DeviceStatesResponse> (buffer, 
                                                   deviceStatesResponseList, 
                                                   TLV_DEVICE_STATES_RESPONSE_LIST);      
    }
  } // namespace mih
