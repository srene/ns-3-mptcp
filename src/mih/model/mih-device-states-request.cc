...
namespace ns3 {
  namespace mih {
    ...
    {
      return TlvMih::GetSerializedSizeU16 ();
    }
    void 
    ...
    {
      TlvMih::SerializeU16 (buffer, m_deviceStatesRequest, TLV_DEVICE_STATES_REQUEST);
    }
    uint32_t 
    DeviceStatesRequest::TlvDeserialize (Buffer &buffer) 
    {
      return TlvMih::DeserializeU16 (buffer, m_deviceStatesRequest, TLV_DEVICE_STATES_REQUEST);
    }
  } // namespace mih
} // namespace ns3
