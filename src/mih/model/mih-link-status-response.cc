...
namespace ns3 {
  namespace mih {
    ...
    {
      return TlvMih::GetSerializedSize<LinkStatusResponse> (linkStatusResponseList);
    }
    void
    TlvSerialize (Buffer &buffer, const LinkStatusResponseList &linkStatusResponseList)
    {
      TlvMih::Serialize<LinkStatusResponse> (buffer, linkStatusResponseList, TLV_LINK_STATUS_RESPONSE_LIST);
    }
    uint32_t
    TlvDeserialize (Buffer &buffer, LinkStatusResponseList &linkStatusResponseList)
    {
      return TlvMih::Deserialize<LinkStatusResponse> (buffer, linkStatusResponseList, TLV_LINK_STATUS_RESPONSE_LIST);    
    }
  } // namespace mih
} // namespace ns3
