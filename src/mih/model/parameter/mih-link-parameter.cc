...
namespace ns3 {
  namespace mih {
    ...
    {
      return TlvMih::GetSerializedSize<LinkParameter> (linkParameterList);
    }
    void
    TlvSerialize (Buffer &buffer, const LinkParameterList &linkParameterList)
    {
      TlvMih::Serialize<LinkParameter> (buffer, linkParameterList, TLV_LINK_PARAMETER_LIST);
    }
    uint32_t
    TlvDeserialize (Buffer &buffer, LinkParameterList &linkParameterList)
    {
      return TlvMih::Deserialize<LinkParameter> (buffer, linkParameterList, TLV_LINK_PARAMETER_LIST);
    }
  } // namespace mih
} // namespace ns3
