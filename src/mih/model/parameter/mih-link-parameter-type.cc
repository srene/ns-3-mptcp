...
namespace ns3 {
  namespace mih {
    ...
    {
      return TlvMih::GetSerializedSize<LinkParameterType> (linkParameterTypeList);
    }
    void 
    TlvSerialize (Buffer &buffer, const LinkParameterTypeList &linkParameterTypeList)
    {
      return TlvMih::Serialize<LinkParameterType> (buffer, linkParameterTypeList, TLV_LINK_PARAMETER_TYPE_LIST);
    }
    uint32_t 
    TlvDeserialize (Buffer &buffer, LinkParameterTypeList &linkParameterTypeList)
    {
      return TlvMih::Deserialize<LinkParameterType> (buffer, linkParameterTypeList, TLV_LINK_PARAMETER_TYPE_LIST);
    }
