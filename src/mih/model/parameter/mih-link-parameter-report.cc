...
namespace ns3 {
  namespace mih {
    ...
    {
      return TlvMih::GetSerializedSize<LinkParameterReport> (linkParameterReportList);
    }
    void
    TlvSerialize (Buffer &buffer, const LinkParameterReportList &linkParameterReportList)
    {
      TlvMih::Serialize<LinkParameterReport> (buffer, linkParameterReportList, TLV_LINK_PARAMETER_REPORT_LIST);
    }
    uint32_t
    TlvDeserialize (Buffer &buffer, LinkParameterReportList &linkParameterReportList)
    {
      return TlvMih::Deserialize<LinkParameterReport> (buffer, linkParameterReportList, TLV_LINK_PARAMETER_REPORT_LIST);    
    }
  } // namespace mih
} // namespace ns3
