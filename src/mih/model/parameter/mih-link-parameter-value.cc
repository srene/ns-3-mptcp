...
namespace ns3 {
  namespace mih {
    LinkParameterValue::LinkParameterValue (uint32_t value) :
      m_value (value)
    {
    ...
    {
      return TlvMih::GetSerializedSizeU32 ();
    }
    void 
    ...
    {
      TlvMih::SerializeU32 (buffer, m_value, TLV_LINK_PARAMETER_VALUE);
    }
    uint32_t
    LinkParameterValue::TlvDeserialize (Buffer &buffer)
    {
      return TlvMih::DeserializeU32 (buffer, m_value, TLV_LINK_PARAMETER_VALUE);
    }
  } // namespace mih
} // namespace ns3
