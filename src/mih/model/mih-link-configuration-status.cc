...
namespace ns3 {
  namespace mih {
    ...
    LinkConfigurationStatus::TlvDeserialize (Buffer &buffer)
    {
      ...
      totalBytesRead += TlvMih::DeserializeBool (buffer, 
                                              m_configurationStatus, 
                                              TLV_LINK_CONFIGURATION_STATUS);
    ...
    {
      return TlvMih::GetSerializedSize<LinkConfigurationStatus> (linkConfigurationStatusList);
    }
    void
    TlvSerialize (Buffer &buffer, const LinkConfigurationStatusList &linkConfigurationStatusList)
    {
      TlvMih::Serialize<LinkConfigurationStatus> (buffer, linkConfigurationStatusList, TLV_LINK_CONFIGURATION_STATUS_LIST);
    }
    uint32_t
    TlvDeserialize (Buffer &buffer, LinkConfigurationStatusList &linkConfigurationStatusList)
    {
      return TlvMih::Deserialize<LinkConfigurationStatus> (buffer, linkConfigurationStatusList, TLV_LINK_CONFIGURATION_STATUS_LIST);      
    }
  } // namespace mih
} // namespace ns3
