...
namespace ns3 {
  namespace mih {
    ...
    MakeBeforeBreakSupport::TlvSerialize (Buffer &buffer) const
    {
      ...
      TlvMih::SerializeBool (buffer, m_supported, TLV_MBB_HO_SUPPORT);
    }
    uint32_t 
    MakeBeforeBreakSupport::TlvDeserialize (Buffer &buffer)
    {
      ...
      totalBytesRead += TlvMih::DeserializeBool (buffer, m_supported, TLV_MBB_HO_SUPPORT);
    ...
    {
      return TlvMih::GetSerializedSize<MakeBeforeBreakSupport> (mbbHoSupportList);
    }
    void 
    TlvSerialize (Buffer &buffer, MakeBeforeBreakSupportList &mbbHoSupportList)
    {
      return TlvMih::Serialize<MakeBeforeBreakSupport> (buffer, mbbHoSupportList, TLV_MBB_HO_SUPPORT_LIST);
    }
    uint32_t 
    TlvDeserialize (Buffer &buffer, MakeBeforeBreakSupportList &mbbHoSupportList)
    {
      return TlvMih::Deserialize<MakeBeforeBreakSupport> (buffer, mbbHoSupportList, TLV_MBB_HO_SUPPORT_LIST);
    }
  } // namespace mih
} // namespace ns3
