...
public:
    ...
    OptDataSeqMapping(TcpOption_t oName, uint64_t dSeqNum, uint16_t dLevelLength, SequenceNumber32 sfSeqNum);
};
...
public:
  ...
  bool AddOptDSN(TcpOption_t optName, uint64_t dSeqNum, uint16_t dLevelLength, SequenceNumber32 sfSeqNum);
