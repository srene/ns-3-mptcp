...
#ifndef TCP_TX_BUFFER64_H
#define TCP_TX_BUFFER64_H
...
public:
   ...
   */
  SequenceNumber64 HeadSequence (void) const;

  /**
   * Returns the last byte's sequence number + 1
   */
  SequenceNumber64 TailSequence (void) const;
   ...
   */
  void SetHeadSequence (const SequenceNumber64& seq);
