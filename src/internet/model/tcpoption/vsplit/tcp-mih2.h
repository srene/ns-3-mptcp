 ...
 */
class TcpMih2 : public TcpSocketBase
{
public:
   ...
   */
  TcpMih2 (void);
  TcpMih2 (const TcpMih2& sock);
  virtual ~TcpMih2 (void);

  // From TcpSocketBase
  virtual int Connect (const Address &address);
  virtual int Listen (void);
  virtual void Handover (uint32_t delay, uint32_t n, uint32_t throughput);
  virtual void SetHandover (uint8_t direct, uint32_t delay, uint32_t n, uint32_t throughput, Mac48Address mac);
  void PostHandover ();
  void Freeze();
protected:
