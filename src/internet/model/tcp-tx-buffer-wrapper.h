...
#ifndef TCP_TX_BUFFER_WRAPPER_H
#define TCP_TX_BUFFER_WRAPPER_H
 ...
 *        the sending buffer.
 */
class TcpTxBufferWrapper : public Object
{
public:
  static TypeId GetTypeId (void);
  TcpTxBufferWrapper (uint32_t n = 0,Ptr<TcpSocketBase> tcpSocketBase = 0);
  virtual ~TcpTxBufferWrapper (void);
