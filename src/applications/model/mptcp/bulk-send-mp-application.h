...
#ifndef BULK_SEND_MP_APPLICATION_H
#define BULK_SEND_MP_APPLICATION_H
 ...
 */
class BulkSendMpApplication : public Application
{
public:
  static TypeId GetTypeId (void);

  BulkSendMpApplication ();

  virtual ~BulkSendMpApplication ();
