 ...
 */
#ifndef PACKET_MP_SINK_HELPER_H
#define PACKET_MP_SINK_HELPER_H
 ...
 * on a set of nodes.
 */
class PacketMpSinkHelper
{
public:
  /**
   * Create a PacketMpSinkHelper to make it easier to work with PacketSinkApplications
   *
   ...
   *
   */
  PacketMpSinkHelper (std::string protocol, Address address);
