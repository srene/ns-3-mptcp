...
#ifndef BULK_SEND_MP_HELPER2_H
#define BULK_SEND_MP_HELPER2_H
 ...
 * on a set of nodes.
 */
class BulkMpSendHelper2
{
public:
  /**
   * Create an BulkMpSendHelper to make it easier to work with BulkSendApplications
   *
   ...
   *        to.
   */
	BulkMpSendHelper2 (std::string protocol, Address address);
