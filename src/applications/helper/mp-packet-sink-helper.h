 ...
 */
#ifndef MP_PACKET_SINK_HELPER_H
#define MP_PACKET_SINK_HELPER_H
...
public:
   ...
   *
   */
	MpPacketSinkHelper (std::string protocol, Address address, uint32_t pr);
